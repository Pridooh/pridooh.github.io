;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA SAYANG','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI SAYANG', 'AKU TAHU KAMU PASTI KESAL', 'TAPI INI BENER DEH ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALINYA', 'PENCET LAGI', 'AYO SEMANGAT SAYANGG', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG SEMANGAT', 'IYA INI BENER TERAKHIR KOK', 'YAUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY SAYANGKUU', 'BABAII', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL :)']
